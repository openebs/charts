...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `2.6.0-RC2`                                  |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `2.6.0-RC2`                                  |
...
| `localprovisioner.imageTag`             | Image Tag for localProvisioner                | `2.6.0-RC2`                                  |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `2.6.0-RC2`                                  |
...
| `snapshotOperator.provisioner.imageTag` | Image Tag for Snapshot Provisioner            | `2.6.0-RC2`                                  |
| `snapshotOperator.controller.image`     | Image for Snapshot Controller                 | `openebs/snapshot-controller`             |
| `snapshotOperator.controller.imageTag`  | Image Tag for Snapshot Controller             | `2.6.0-RC2`                                  |
...
| `ndm.imageTag`                          | Image Tag for Node Disk Manager               | `1.2.0-RC2`                                   |
...
| `ndmOperator.imageTag`                  | Image Tag for NDM Operator                    | `1.2.0-RC2`                                   |
| `ndmOperator.resources`                 | Set resource limits for NDM Operator          | `{}`                                      |
| `jiva.image`                            | Image for Jiva                                | `openebs/jiva`                            |
| `jiva.imageTag`                         | Image Tag for Jiva                            | `2.6.0-RC2`                                  |
...
| `cstor.pool.imageTag`                   | Image Tag for cStor Pool                      | `2.6.0-RC2`                                  |
| `cstor.poolMgmt.image`                  | Image for cStor Pool  Management              | `openebs/cstor-pool-mgmt`                 |
| `cstor.poolMgmt.imageTag`               | Image Tag for cStor Pool Management           | `2.6.0-RC2`                                  |
| `cstor.target.image`                    | Image for cStor Target                        | `openebs/cstor-istgt`                     |
| `cstor.target.imageTag`                 | Image Tag for cStor Target                    | `2.6.0-RC2`                                  |
| `cstor.volumeMgmt.image`                | Image for cStor Volume  Management            | `openebs/cstor-volume-mgmt`               |
| `cstor.volumeMgmt.imageTag`             | Image Tag for cStor Volume Management         | `2.6.0-RC2`                                  |
| `helper.image`                          | Image for helper                              | `openebs/linux-utils`                     |
| `helper.imageTag`                       | Image Tag for helper                          | `2.6.0-RC2`                                  |
...
| `policies.monitoring.imageTag`          | Image Tag for Prometheus Exporter             | `2.6.0-RC2`                                  |
