...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `2.1.0`                                  |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `2.1.0`                                  |
...
| `localprovisioner.imageTag`             | Image Tag for localProvisioner                | `2.1.0`                                  |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `2.1.0`                                  |
...
| `snapshotOperator.provisioner.imageTag` | Image Tag for Snapshot Provisioner            | `2.1.0`                                  |
| `snapshotOperator.controller.image`     | Image for Snapshot Controller                 | `openebs/snapshot-controller`             |
| `snapshotOperator.controller.imageTag`  | Image Tag for Snapshot Controller             | `2.1.0`                                  |
...
| `cstor.pool.imageTag`                   | Image Tag for cStor Pool                      | `2.1.0`                                  |
| `cstor.poolMgmt.image`                  | Image for cStor Pool  Management              | `openebs/cstor-pool-mgmt`                 |
| `cstor.poolMgmt.imageTag`               | Image Tag for cStor Pool Management           | `2.1.0`                                  |
| `cstor.target.image`                    | Image for cStor Target                        | `openebs/cstor-istgt`                     |
| `cstor.target.imageTag`                 | Image Tag for cStor Target                    | `2.1.0`                                  |
| `cstor.volumeMgmt.image`                | Image for cStor Volume  Management            | `openebs/cstor-volume-mgmt`               |
| `cstor.volumeMgmt.imageTag`             | Image Tag for cStor Volume Management         | `2.1.0`                                  |
| `helper.image`                          | Image for helper                              | `openebs/linux-utils`                     |
| `helper.imageTag`                       | Image Tag for helper                          | `2.1.0`                                  |
...
| `policies.monitoring.imageTag`          | Image Tag for Prometheus Exporter             | `2.1.0`                                  |
