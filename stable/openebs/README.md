...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `1.10.0-RC2`                                   |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `1.10.0-RC2`                                   |
...
| `localprovisioner.imageTag`             | Image Tag for localProvisioner                | `1.10.0-RC2`                                   |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `1.10.0-RC2`                                   |
...
| `snapshotOperator.provisioner.imageTag` | Image Tag for Snapshot Provisioner            | `1.10.0-RC2`                                   |
| `snapshotOperator.controller.image`     | Image for Snapshot Controller                 | `quay.io/openebs/snapshot-controller`     |
| `snapshotOperator.controller.imageTag`  | Image Tag for Snapshot Controller             | `1.10.0-RC2`                                   |
...
| `ndm.imageTag`                          | Image Tag for Node Disk Manager               | `0.5.0-RC2`                                  |
...
| `ndmOperator.imageTag`                  | Image Tag for NDM Operator                    | `0.5.0-RC2`                                  |
| `jiva.image`                            | Image for Jiva                                | `quay.io/openebs/jiva`                    |
| `jiva.imageTag`                         | Image Tag for Jiva                            | `1.10.0-RC2`                                   |
...
| `cstor.pool.imageTag`                   | Image Tag for cStor Pool                      | `1.10.0-RC2`                                   |
| `cstor.poolMgmt.image`                  | Image for cStor Pool  Management              | `quay.io/openebs/cstor-pool-mgmt`         |
| `cstor.poolMgmt.imageTag`               | Image Tag for cStor Pool Management           | `1.10.0-RC2`                                   |
| `cstor.target.image`                    | Image for cStor Target                        | `quay.io/openebs/cstor-istgt`             |
| `cstor.target.imageTag`                 | Image Tag for cStor Target                    | `1.10.0-RC2`                                   |
| `cstor.volumeMgmt.image`                | Image for cStor Volume  Management            | `quay.io/openebs/cstor-volume-mgmt`       |
| `cstor.volumeMgmt.imageTag`             | Image Tag for cStor Volume Management         | `1.10.0-RC2`                                   |
| `helper.image`                          | Image for helper                              | `quay.io/openebs/linux-utils`             |
| `helper.imageTag`                       | Image Tag for helper                          | `1.10.0-RC2`                                   |
...
| `policies.monitoring.imageTag`          | Image Tag for Prometheus Exporter             | `1.10.0-RC2`                                   |
